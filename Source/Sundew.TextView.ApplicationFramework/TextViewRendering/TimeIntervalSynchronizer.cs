...
namespace Sundew.TextView.ApplicationFramework.TextViewRendering
{
    ...
    public class TimeIntervalSynchronizer
    {
        ...
        /// <summary>
        /// Synchronizes the time between calls.
        /// </summary>
        ...
        /// <returns>
        /// A value task with a value indicating whether the operation was cancelled.
        /// </returns>
            ...
            bool continueOnCapturedContext = false)
        {
            ...
            {
                var wasAborted = await autoResetEventAsync.WaitAsync(delay, cancellationToken).ConfigureAwait(continueOnCapturedContext);
                if (wasAborted)
                {
