...
namespace Sundew.TextView.ApplicationFramework.Input
{
    ...
    public interface IInputManagerReporter : IReporter
    {
        ...
        /// <summary>
        /// Raiseds the event for input targets.
        /// </summary>
        /// <typeparam name="TEventArgs">The type of the event arguments.</typeparam>
        /// <param name="inputEvent">The input event.</param>
        /// <param name="inputTargets">The input targets.</param>
        /// <param name="eventArgs">The event arguments.</param>
        void RaisedEventForInputTargets<TEventArgs>(InputEvent<TEventArgs> inputEvent, List<object?> inputTargets, TEventArgs eventArgs);
    }
}